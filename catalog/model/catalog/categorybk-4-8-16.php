...
class ModelCatalogCategory extends Model {
    ...
    public function addQuestion($data) {
        $insert = $this->db->query("insert into oc_question values('', '" . $data['customer_id'] . "', '" . $data['product_id'] . "', '" . $data['question'] . "', '" . $data['date_time'] . "' )");
    }

    public function getQuestionAnswer($product_id) {

        $all_questions = $this->db->query("select * from oc_question where product_id = $product_id");
