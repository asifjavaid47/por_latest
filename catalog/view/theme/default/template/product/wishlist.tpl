...
<div class='container'>
	...
	<div class='row'>
		...
		<div class="col-sm-10 col-md-10 col-lg-10 product-main-container">
			<div class="product-main-container" id='all_results'>
		...
		success: function (data)
		{
			...
			else
			{
				...
				for(i=0;i<number_of_products;i++)
				{
					...
					{
							product_type_data = '<span class="liquidation_ribbon"></span>';						
					}
					else
					{
						product_type_data = '';
					...
					all_products_data1 = '<div class="product-one-main product-one-block" style="margin: 0 20px 20px 0 !important;">'+product_type_data+'<div class="grid-overflow" style="width:inherit!important;height:inherit;"><a href="#" class="whole_product_redirections prevent_default2" quantity="1" amount="$'+parsed_price_original+'" product_id="'+parsed_data['products_details'][i].product_id+'" original_quantity="1" original_price="$'+parsed_price_original+'" ></a><div class="product-img-block"><img src="'+product_main_image+'" alt=""/></div><div class="product-title product-title-category">'+parsed_data['products_description'][i][0].name+'</div><div calss="product_status">'+product_status+'</div><label class="price-content-container">Precio</label><div class="price-block-container" style="font-weight: bold;float: right;text-align: right;line-height: 15px;height:15px; font-size: 12px;padding-right: 5px;">'+parsed_price+'</div><div class="clr"></div><label class="price-content-container">P.min</label><div class="min-price-block" style="width:auto;font-weight: bold;float: right;text-align: right;line-height: 15px;height:15px; font-size: 12px;padding-right: 5px;">'+minimum_price_currently+'</div><div class="clr"></div><div style="text-align: center;" class="product-address-content-container">Capital Federal</div><div class="over-table-block over-table-block-category"><div class="clr"></div><div class="fix_tier_price_at_bottom" style="text-align: center;"><div class="heart-block-container remove_from_wishlist" title="Remove from Wishlist" product_id="'+parsed_data['products_details'][i].product_id+'"><img src="<?php echo $base;?>catalog/view/theme/default/image/remove-heart-icon.png" alt=""></div><div class="clr"></div><div class="product_title_tier_prices product_title_tier_prices-category" style="height:36px!important;">'+parsed_data['products_description'][i][0].name+'</div><div class="first-amt-block"><a href="#" class="prevent_default" quantity="1" amount="$'+parsed_price_original+'" product_id="'+parsed_data['products_details'][i].product_id+'" original_quantity="1" original_price="$'+parsed_price_original+'"><div class="one-no-block one-no-block-category prod-list-amt-first prod-list-amt-first-category">x1</div><div class="one-block-amt prod-list-amt-first prod-list-amt-first-category" style="line-height: 18px;">'+parsed_price+'</div></a></div>';
					number_of_product_discounts = parsed_data['products_discounts'][i].length;
					all_products_data2 = '';
			...
			$('#grid-view-area').html(all_products_data);
		}
	});
