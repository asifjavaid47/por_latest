  ...
  ?>
	...
	<div class="clearfix"></div>
	  ...
	  <br />
	   <?php
	  $aa=0;
	for($i = 0; $i < sizeof($reported_data['products']); $i++)
        {
            ?>
            <div class="col-sm-12" style="margin-top:81px;">
                <div class="col-sm-6">
                    <?php
                        if($reported_data['products'][$i]['type_of_issue']==1){
                                echo"<p><b>Report Type:&nbsp;It has contact detail</b></p>";
                        }
                        if($reported_data['products'][$i]['type_of_issue']==2){
                        echo"<p><b>Report Type:&nbsp;Post a lower then accuitly paid</b></p>";
                        }
                        if($reported_data['products'][$i]['type_of_issue']==3){
                        echo"<p><b>Report Type:&nbsp;It is evident that sells a copy or forgery</b></p>";
                        }
                        if($reported_data['products'][$i]['type_of_issue']==4){
                        echo"<p><b>Report Type:&nbsp;Sells a product that dose not meet the term and condition of the site</b></p>";
                        }
                        if($reported_data['products'][$i]['type_of_issue']==5){
                        echo"<p><b>Report Type:&nbsp;Others</b></p>";
                        }
                    ?>
                    <div class="col-sm-2"><img src="../image/<?php echo $reported_data['products'][$i]['image']; ?>" height="84px" width="61px"></div>
                    <div class="col-sm-10">
                        <p><b><?php echo $reported_data['products'][$i]['name']; ?></b></p>
                        <p>$<?php echo $reported_data['products'][$i]['price']; ?>  x 1 Unit</p>
                    </div>
                </div>
                <div class="col-sm-6 text-right">
                    ...
                    ?>			
                    <span><?php  echo date(' j /m /Y ', strtotime($reported_data['products'][$i]['date_time']));  ?></span>
	  	</div>
                <?php 
                    if(isset($_GET['token']))
                    {
                ...
                <div class="col-sm-12">
                    <div class="col-sm-9">
                        ...
                        <br /><label><?php echo $reported_data['addresses'][$i]['v_name'];?></label><br />
                        <label><?php echo $reported_data['addresses'][$i]['telephone']; ?></label><br />
                        <label><?php echo $reported_data['addresses'][$i]['email']; ?></label><br />
                        <p><?php echo $reported_data['addresses'][$i]['v_address'];   ?> </p><br />

                        <?php $cust='&cust='.$reported_data['addresses'][$i]['customer_id']; ?>
                        <?php $rpt='&rpt='.$reported_data['products'][$i]['report_id']; ?>
                        <a href="index.php?route=custom/dashboardreport&xds=<?php echo $reported_data['products'][$i]['product_id'].$token.$cust.$rpt; ?>">View Details</a>
                  </div>
                </div>
            </div>
            <?php $aa++;  } ?>
